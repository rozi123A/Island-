...
const features: Feature[] = [
  {
    ...
    title: "اتصالات فورية",
    description: "اتصل بأشخاص حقيقيين في ثوان. بدون انتظار، بدون تأخير.",
    gradient: "from-purple-600 to-blue-600",
  },
  {
    icon: <Shield className="w-8 h-8" />,
    title: "تحقق من الملفات الشخصية",
    description: "تحقق من الذكاء الاصطناعي من جميع المستخدمين قبل المطابقة.",
    gradient: "from-pink-600 to-purple-600",
  },
  {
    icon: <Lock className="w-8 h-8" />,
    title: "خصوصية تامة",
    description: "لا توجد سجلات، لا توجد بيانات شخصية مشتركة. اتصالات مجهولة تماماً.",
    gradient: "from-cyan-600 to-blue-600",
  },
  {
    icon: <Users className="w-8 h-8" />,
    title: "مجتمع عالمي",
    description: "تواصل مع أشخاص من جميع أنحاء العالم وثقافات مختلفة.",
    gradient: "from-orange-600 to-pink-600",
  },
  {
    icon: <Smartphone className="w-8 h-8" />,
    title: "متاح على جميع الأجهزة",
    description: "استخدم على الويب أو التطبيق. متوافق مع جميع الأجهزة.",
    gradient: "from-green-600 to-cyan-600",
  },
  {
    icon: <Award className="w-8 h-8" />,
    title: "بدون تسجيل",
    description: "ابدأ على الفور. لا حاجة لإنشاء حساب أو التحقق من البريد الإلكتروني.",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            منصة دردشة فيديو عشوائية حديثة مع أفضل الميزات والحماية
          </p>
        </div>
